...
function BookEntry () {
  ...
  function handleFormSubmit(event) {
    ...
    push(booksRefInDatabase, newBookData)
      ...
      .catch(() => {
        setErrorMessage('Could not add your book. Please try again.');
      });
  }

  const tagButtons = ['Inspirational', 'Dark', 'Emotional', 'Uplifting', 'Thought-provoking', 'Suspenseful', 'Heartwarming', 'Adventurous'].map(tag => {
    const isActive = tagsInput.includes(tag);
